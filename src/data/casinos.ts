...
export const casinos: Casino[] = [
  ...
  },
  {
    ...
    "faqs": [
      ...
      {
        "question": "What is LeoVegas's KSA licence number?",
        "answer": "LeoVegas operates under KSA licence 1970/01.297.569, granted to LeoVegas Gaming p.l.c. (registered in Malta under company number C59314) on 7 September 2023, valid until 7 September 2028. This can be independently verified on the official Kansspelautoriteit website."
      },
      {
        "question": "How long do withdrawals take at LeoVegas?",
        "answer": "E-wallet withdrawals via Skrill and Neteller are processed within 0-24 hours with no fees. Card withdrawals (Visa/Mastercard) take 2-5 business days, and Trustly bank transfers take 1-3 business days. None of LeoVegas's listed payment methods carry withdrawal fees."
      },
      {
        "question": "What happens to the free spins if I don't use them in time?",
        "answer": "The welcome offer's up to 2,600 free spins (worth €0.20 each on Gates of Olympus Super Scatter) expire just 3 days after being credited, separate from the main 14-day wagering window for the deposit bonus. Live casino and table games do not count toward clearing the free spins wagering requirement."
      },
      {
        "question": "Does LeoVegas have progressive jackpot slots?",
        "answer": "Yes. Alongside its own exclusive LeoJackpot network, LeoVegas offers major third-party progressive jackpots including Mega Moolah and WowPot, both known for multi-million-euro prize pools."
      },
      {
  ...
  },
  {
    ...
    "faqs": [
      ...
      {
        "question": "Is LuckyNiki a safe and legitimate casino?",
        "answer": "Yes. LuckyNiki is not an unlicensed offshore operator — it holds two verifiable tier-one licences (UKGC 39326 and MGA/B2C/248/2014) from regulators with a track record of enforcement, and independently audited RNG certification from BMM Testlabs and eCOGRA. Our audit rates it 8.8/10 with a Certified compliance score of 88/100, the same tier as other well-established regulated operators we cover. The main caveats are a medium (not insured) level of player fund protection and an unconfirmed GGL licence for German players — neither affects UK, Danish, Canadian, Irish, or Swedish players."
      },
      {
        "question": "Is LuckyNiki available to players in Sweden, Denmark, Canada, or Ireland?",
        "answer": "Yes. LuckyNiki's UKGC and MGA licences cover these markets and our audit specifically recommends it for GB, DK, CA, IE, and SE players. It is not available to residents of the Netherlands, United States, France, or Spain due to those countries' own licensing regimes."
      },
      {
        "question": "What games and software providers does LuckyNiki use?",
        "answer": "LuckyNiki's library runs to 3,000+ titles, including slots from NetEnt, Pragmatic Play, Play'n GO, and Microgaming, plus a live dealer casino (roulette, blackjack, baccarat, and game shows) powered by Evolution Gaming, the industry's leading live-casino provider."
      }
    ],
  ...
  },
  {
    ...
    "faqs": [
      ...
      {
        "question": "Does Toto Casino really have zero wagering requirements on free spins?",
        "answer": "Yes. Winnings from Toto's welcome free spins are paid out as real cash with a 0x wagering requirement — no playthrough at all before withdrawal. This is genuinely unusual in the industry, where 30x-40x wagering on winnings is the norm even for free spin offers."
      },
      {
        "question": "How fast are withdrawals at Toto Casino?",
        "answer": "Very fast. Toto processes withdrawals via iDEAL, typically within 5 minutes, since iDEAL is a direct real-time bank transfer method and the mandatory standard for Dutch state lottery brands."
      },
      {
        "question": "Is Toto Casino integrated with CRUKS self-exclusion?",
        "answer": "Yes. CRUKS (the Dutch national self-exclusion register) is checked on every single login, not just at registration. A player registered with CRUKS cannot access their account until their exclusion period ends."
      },
      {
        "question": "What payment methods does Toto Casino support?",
        "answer": "Toto Casino supports iDEAL exclusively for both deposits and withdrawals. This is a deliberate choice rather than a limitation — iDEAL is a direct-to-bank method with no card or e-wallet intermediary, which is why withdrawals clear in minutes rather than days."
      }
    ],
  ...
  },
  {
    ...
    "faqs": [
      ...
      {
        "question": "What is Winbeast's welcome bonus wagering requirement?",
        "answer": "Winbeast's welcome bonus carries a 45x wagering requirement applied to the combined deposit and bonus amount — which works out to roughly 112.5x the bonus value itself before a withdrawal is possible. This is significantly steeper than the 30x-40x bonus-only average seen at MGA and UKGC operators, and the bonus expires after just 7 days."
      },
      {
        "question": "How long does self-exclusion take to process at Winbeast?",
        "answer": "Self-exclusion is not instant. Players must email support and wait a standard 48-72 hour turnaround, during which the account remains active and deposits/play are still possible. This is slower than KSA and UKGC operators, where self-exclusion via CRUKS or GAMSTOP takes effect immediately upon registration."
      },
      {
        "question": "Is Winbeast connected to any national self-exclusion database?",
        "answer": "No. Winbeast has no connection to national self-exclusion registers such as CRUKS (Netherlands) or GAMSTOP (UK). Players who have self-excluded through those national schemes are not blocked from creating a new account at Winbeast."
      },
      {
        "question": "Are there restrictions on which games can be played while a bonus is active?",
        "answer": "Yes. While a Winbeast bonus is active, wagering is restricted to slots with an RTP of 96.5% or lower — any higher-RTP slots are barred from contributing to wagering until the bonus is cleared or forfeited."
      },
      {
        "question": "Does Winbeast charge fees on deposits or withdrawals?",
        "answer": "Credit card transactions (Visa/Mastercard) carry a 2.5% processing fee, and withdrawals via this method take 3-5 business days. MiFinity e-wallet transfers are fee-free with a faster 24-48 hour withdrawal window."
      }
    ]
  }
];
