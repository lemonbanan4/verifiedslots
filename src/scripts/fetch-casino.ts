...
Here is the exact JSON schema structure required:
{
  ...
  "licenseType": "ksa" | "mga" | "curacao" (primary license, e.g. mga),
  "licenseTypes": ["ksa", "mga", "curacao"] (array containing all license jurisdictions held by this operator, e.g. ["ksa", "mga"]),
  "restrictedCountries": ["NL"] or [] (if KSA, restrictedCountries must NOT contain "NL". If mga/curacao, it must contain "NL"),
